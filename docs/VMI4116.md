...
| File | Description |
|------|-------------|
| `vmeApp/src/devAoVMI4116.c` | Device support for ao records |
...
| File | Description |
|------|-------------|
| `vmeApp/Db/VME_DAC.db` | Generic DAC template with rate-of-change limiting and tweaking. Set `DTYP="VMIVME-4116"`. |
